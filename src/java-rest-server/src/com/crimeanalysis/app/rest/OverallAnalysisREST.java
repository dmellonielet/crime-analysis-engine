...
import com.crimeanalysis.app.beans.OverallAnalysis;
import com.crimeanalysis.app.db.dao.OverallAnalysisDAO;
import com.crimeanalysis.app.util.DateUtil;

public class OverallAnalysisREST
{
	@GET
	@Path("/overall")
	@JSONP(queryParam="callback")
	@Produces({"application/x-javascript"})
	public ArrayList<OverallAnalysis> getAllTestData(@QueryParam("callback") String callback,
												   ...
												   @QueryParam("radius") String radius) 
	{
		...
		OverallAnalysisDAO dao=new OverallAnalysisDAO();
